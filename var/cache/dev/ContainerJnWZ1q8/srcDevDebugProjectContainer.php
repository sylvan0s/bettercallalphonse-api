...
class srcDevDebugProjectContainer extends Container
{
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'api_platform.description' => 'API de l\'application BetterCallAlphonse',
