...
class __TwigTemplate_04e2408a8381380b075757fea220f20e60ff0c1414e3fa24f50603b7f6615024 extends Twig_Template
{
    private $source;
...
";
    ...
    ";
        ...
        <div id=\"";
            ...
            ";
                // line 247
                echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new Twig_Error_Runtime('Variable "log" does not exist.', 247, $this->source); })()), "context", array()), 1);
                echo "
        </div>
        ...
        ";
                ...
                ";
                    // line 252
                    echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new Twig_Error_Runtime('Variable "log" does not exist.', 252, $this->source); })()), "context", array()), "exception", array()), "trace", array()), 1);
                    echo "
            </div>
        ";
                }
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/var/www/bettercallalphonse-api/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig");
    }
}
